...
dict set ap_memory_interface_dict mem { MEM_WIDTH 32 MEM_SIZE 4096 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
...
set Spec2ImplPortList { 
	...
	pstrb { ap_none {  { pstrb out_data 1 4 } } }
}

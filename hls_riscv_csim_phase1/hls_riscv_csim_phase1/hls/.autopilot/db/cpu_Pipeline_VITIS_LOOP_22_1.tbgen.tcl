set moduleName cpu_Pipeline_VITIS_LOOP_22_1
set isTopModule 0
...
set cdfgNum 5
set C_modelName {cpu_Pipeline_VITIS_LOOP_22_1}
...
set C_modelArgList {
	{ reg_file int 32 regular {array 32 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "reg_file", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	reg_file { ap_memory {  { reg_file_address0 mem_address 1 5 }  { reg_file_ce0 mem_ce 1 1 }  { reg_file_we0 mem_we 1 1 }  { reg_file_d0 mem_din 1 32 } } }
}

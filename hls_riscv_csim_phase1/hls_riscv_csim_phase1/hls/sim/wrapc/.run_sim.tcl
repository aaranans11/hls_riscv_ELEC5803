...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "cpu.autotvin.dat"
	set constFileTvOut       "cpu.autotvout.dat"
	set constFileHdlTvIn     "cpu.autohdltvin.dat"
	set constFileHdlTvOut    "cpu.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

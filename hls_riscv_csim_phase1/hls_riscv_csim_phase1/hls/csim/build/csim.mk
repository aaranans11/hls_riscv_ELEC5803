...
HLS_SOURCES = ../../../../loop.c ../../../../../RISCV-RV32I-H1/riscv32i_tb.cc ../../../../../RISCV-RV32I-H1/riscv32i.cc
...
$(ObjDir)/loop.o: ../../../../loop.c $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../loop.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -std=gnu99 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/loop.d

$(ObjDir)/riscv32i_tb.o: ../../../../../RISCV-RV32I-H1/riscv32i_tb.cc $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../RISCV-RV32I-H1/riscv32i_tb.cc in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/riscv32i_tb.d

$(ObjDir)/riscv32i.o: ../../../../../RISCV-RV32I-H1/riscv32i.cc $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../RISCV-RV32I-H1/riscv32i.cc in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=cpu $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/riscv32i.d
